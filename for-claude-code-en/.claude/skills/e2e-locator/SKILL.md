...
→ See [e2e-locator/ant-design-select.md](./ant-design-select.md) for details (the two-layer background, when searching is needed, the truncated-display caveat, and the per-library class table)
...
→ See [e2e-locator/ant-design-tabs-disabled.md](./ant-design-tabs-disabled.md) for details
